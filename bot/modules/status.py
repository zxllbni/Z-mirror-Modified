...
async def mirror_status(_, message):
    ...
    if count == 0:
        ...
        msg += f"\n<b>CPU</b>: {cpu_percent()}% | <b>FREE</b>: {free}" \
               ...
               f"\n\n<a href='https://t.me/L_abani'>𝑩𝒐𝒕 𝒃𝒚 🚀 Nᴏᴏʙ-Mɪʀʀᴏʀ</a>"
...
def bot_sys_stats():
    ...
    for download in download_dict.values():
        ...
        if status in MirrorStatus.STATUS_QUEUEDL or status in MirrorStatus.STATUS_QUEUEUP:
            ...
            seed += 1
    bmsg = f'______✈️NOOB Bot Info______\n\n'
...
async def stats(_, message, edit_mode=False):
    ...
    bot_stats = f'<b><i><u>✈️NOOB Bot Statistics</u></i></b>\n\n'\
    ...
    sys_stats = f'<b><i><u>✈️NOOB System Statistics</u></i></b>\n\n'\
...
async def send_bot_limits(_, query):
    ...
    bot_limit = f'<b><i><u>✈️NOOB Bot Limitations</u></i></b>\n' \
